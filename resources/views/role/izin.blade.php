        ...
        @role('super_admin')
            <div class="col-md-6 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br>
                        <form method=post action="{{ isset($izin_e) ? route('update_izin') : route('tambah_izin') }}"
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input name=izin type="text" class="form-control"
                                        value="{{ isset($izin_e->name) ? $izin_e->name : '' }}" placeholder=Izin>
                                    {!! $errors->first('izin') !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input name=jenis type="text" class="form-control"
                                        value="{{ isset($izin_e->guard_name) ? $izin_e->guard_name : '' }}" placeholder=Jenis>
                                    {!! $errors->first('jenis') !!}
                                </div>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($izin as $r)
                                        <tr class="even pointer">
                                            ...
                                            <td class=" last">
                                                @role('super_admin')
                                                    <a href="{{ route('edit_izin', $r->id) }}"><i class="fa fa-pencil"></i></a>
                                                    &nbsp&nbsp

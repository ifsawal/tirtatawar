                            ...
                            <tbody>
                                @foreach ($user as $u)
                                    <tr>
                                        ...
                                        <td>{{ $u->nama }}</td>
                                        <td>{{ $u->email }}</td>
                                        <td><a href="{{ route('detil_hakakses', $u->id) }}"><i class="fa fa-bars"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="table-responsive">
                            Hak Akses :
                            <button type="button"
                                class="btn btn-round btn-secondary">{{ $user_role[0]->role->name }}</button>
                            @if ($user_role[0]->role->name != 'super_admin')
                                <a
                                    href="{{ route('hapus_detil_hakakses', [encrypt($u->id), encrypt($user_role[0]->role->id)]) }}"><i
                                        class="btn btn-round btn-danger">Hapus Akses</i></a>
                            @endif

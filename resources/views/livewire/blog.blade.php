            ...
            <div class="row">
                                            ...
                                            <div class="post-slider slider-sm rounded">
                                                @if ($a->image != '')
                                                    <img loading="lazy" decoding="async"
                                                        src="{{ asset('storage/' . $a->image) }}" alt="Post Thumbnail">
                                                @endif
                                            </div>
                                            <div class="pt-4">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="widget widget-categories">
                        <h5 class="widget-title"><span>Katagori</span></h5>
                        <ul class="list-unstyled widget-list">
                            @if ($katagori->isNotEmpty())
                                @foreach ($katagori as $k)
                                    <li><a wire:navigate 
                                            href="{{ route('blog') . '?katagori_url=' . $k->slug }}">{{ $k->nama }}
                                        </a>
                                    </li>
                                @endforeach
                            @endif

        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Tentang Kami</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a wire:navigate href="{{route('beranda')}}">Beranda</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a >Tentang kami</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <img loading="lazy" decoding="async" src="{{ asset('storage/' . $hal->image) }}" alt="Business Loans &lt;br&gt; For Daily Expenses" class="rounded w-100">
                </div>
            </div>
            @endif
        </div>

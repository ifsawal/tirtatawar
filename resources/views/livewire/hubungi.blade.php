          ...
          <div class="container">
              <div class="row">
                  <div class="col-8 mx-auto text-center">
                      <h2 class="mb-3 text-capitalize">Kontak Kami</h2>
                      <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                          <li class="list-inline-item"><a wire:navigate href="{{ route('beranda') }}">Beranda</a>
                          </li>
                          <li class="list-inline-item">/ &nbsp; <a >Kontak</a>
                          </li>
                      </ul>
                  </div>
              </div>
              ...
              <div class="row justify-content-center align-items-center">
                  <div class="col-lg-6">
                      <div class="section-title text-center">
                          ...
                          <p>Kantor PDAM Tirta Tawar Jl. Mahkamah, Asir Asir Asia, Kec. Lut Tawar, Kabupaten Aceh Tengah, Aceh 24519</p>
                      </div>
                  </div>
                  <div class="col-lg-10">
                              ...
                              <div class="col-lg-6 mt-5 mt-lg-0">
                                  <div class="contact-info">
                                      <div class="block mt-0">
                                          <h4 class="h5">Punya keluhan?</h4>
                                          <div class="content">Hubungi kami di 
                                              <br> <a href="tel:+XXX111222">08xxx</a> 
                                              <br>Senin - Sabtu
                                              <br>jam 08.00 s/d 16.00 </div>
                                      </div>

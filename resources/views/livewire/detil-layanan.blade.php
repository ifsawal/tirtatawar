        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">{{$layanan->judul}}</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a wire:navigate href="{{route('beranda')}}">Beranda</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a wire:navigate href="{{route('layanan')}}">Services</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; {{$layanan->judul}}
                        </li>
                    </ul>
                </div>
            </div>

        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">Pertanyaan mu</p>
                        <h1>Orang dibalakang kami</h1>
            ...
            <div class="row position-relative">
                ...
                @if ($anggota->isNotEmpty())
                    ...
                    <x-kartu-anggota :anggota="$a"></x-kartu-anggota>
                    @endforeach
                @endif

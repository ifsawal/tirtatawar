	...
	<nav class="navbar navbar-expand-xl navbar-light text-center py-3">
		<div class="container">
			<a class="navbar-brand" wire:navigate class="nav-link" href="{{route('beranda')}}">
				<img loading="prelaod" decoding="async" class="img-fluid" width="160" src="{{ asset('/depan/images/logo.png')}}" alt="Wallet">
			</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav m-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"> <a wire:navigate class="nav-link" href="{{route('hal','tentang-kami')}}">Tentang Kami</a></li>
					<li class="nav-item "> <a wire:navigate class="nav-link" href="{{route('layanan')}}">Layanan</a></li>
					<li class="nav-item "> <a wire:navigate class="nav-link" href="{{route('tim')}}">Tim Kami</a></li>
					<li class="nav-item "> <a wire:navigate class="nav-link" href="{{route('blog')}}">Blog</a></li>
					<li class="nav-item "> <a wire:navigate class="nav-link" href="{{route('faq')}}">Pertanyaan</a></li>

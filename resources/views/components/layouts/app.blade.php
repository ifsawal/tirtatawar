...
<head>
    <meta charset="utf-8">
    <title>{{ $title ?? 'Tirtatawar.com' }}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=5">
    <meta name="description" content="This is meta description">
    <meta name="author" content="Themefisher">
    <link rel="shortcut icon" href="{{ asset('/depan/images/favicon.png') }}" type="image/x-icon">
    <link rel="icon" href="{{ asset('/depan/images/favicon.png') }}" type="image/x-icon">
    ...
    <!-- # CSS Plugins -->
    <link rel="stylesheet" href="{{ asset('/depan/plugins/slick/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('/depan/plugins/font-awesome/fontawesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('/depan/plugins/font-awesome/brands.css') }}">
    <link rel="stylesheet" href="{{ asset('/depan/plugins/font-awesome/solid.css') }}">
...
<body>
    ...
    <header class="navigation bg-tertiary">
        <nav class="navbar navbar-expand-xl navbar-light text-center py-3">
            <div class="container">
                <a class="navbar-brand" wire:navigate class="nav-link" href="{{ route('beranda') }}">
                    <img loading="prelaod" decoding="async" class="img-fluid" width="160"
                        src="{{ asset('/depan/images/logo.png') }}" alt="Wallet">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item "> <a wire:navigate class="nav-link"
                                ...
                                <li class="nav-item "> <a wire:navigate class="nav-link" href="{{ route('tim') }}">Tim
                                        </a></li>
                        <li class="nav-item "> <a wire:navigate class="nav-link" href="{{ route('blog') }}">Blog</a>
                        </li>
                        <li class="nav-item"> <a wire:navigate class="nav-link"
                                href="{{ route('hal', 'tentang-kami') }}">Tentang Kami</a></li>
                        <li class="nav-item "> <a wire:navigate class="nav-link"
                                href="{{ route('faq') }}">Pertanyaan</a></li>

                    </ul>
                    <a wire:navigate href="{{ route('kontak') }}" class="btn btn-outline-primary">Hubungi Kami</a>
                </div>
            </div>
        </nav>
    </header>
    ...
    <footer class="section-sm bg-tertiary">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <div class="footer-widget">
                        ...
                        <ul class="list-unstyled">
                            @php
                                $a = App\Models\Website\Layanan::orderBy('id')->take(5)->get();
                            @endphp
                            @if ($a->isNotEmpty())
                                @foreach ($a as $b)
                                    <li class="mb-2"><a href="service-details.html">{{ $b->judul }}</a>
                                    </li>
                                @endforeach
                            @endif
                        </ul>
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <div class="footer-widget">
                        <h5 class="mb-4 text-primary font-secondary">Link Cepat</h5>
                        <ul class="list-unstyled">
                            <li class="mb-2"><a wire:navigate href="{{ route('hal', 'tentang-kami') }}">Tentang
                                    kami</a>
                            </li>
                            <li class="mb-2"><a href="{{ route('kontak') }}">Kontak</a>
                            </li>
                            <li class="mb-2"><a href="{{ route('blog') }}">Blog</a>
                            </li>
                            <li class="mb-2"><a href="{{ route('tim') }}">Tim</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <!-- # JS Plugins -->
    <script src="{{ asset('/depan/plugins/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('/depan/plugins/bootstrap/bootstrap.min.js') }}"></script>

...
use App\Http\Controllers\Api\Laporan\LaporanMenunggakPetugasController;
...
Route::group(['middleware' => ['auth:sanctum', 'abilities:admin']], function () {
    ...
    Route::get('/user-petugas', [UserController::class, 'user_petugas']);
    ...
    Route::post('/catat', [PencatatanController::class, 'store'])->middleware('auth.permission:catat_berpoto'); //bergambar
    Route::post('/catatmanual', [PencatatanController::class, 'catat_manual'])->middleware('auth.permission:pencatatan manual');
    Route::post('/databanyak', [PencatatanController::class, 'ambil_data_belum_tercatat']);
    Route::post('/simpan-data-banyak', [PencatatanController::class, 'simpan_data_banyak'])->middleware('auth.permission:pencatatan manual');
    ...
    Route::get('/laporan-belum-bayar/{tahun}/{batas_data_diambil}', [LaporanBelumBayarController::class, 'laporan_belum_bayar']);
    ...
    Route::get('/download-menunggak-petugas', [LaporanMenunggakPetugasController::class, 'download_menunggak_petugas'])->middleware('auth.permission:download_stok_op_name');
    ...
    Route::post('/downloadlaporanbayar-excel-test', [LaporanBayarController::class, 'proses_download_laporan_bayar_excel']);
    ...
    Route::post('/isimeteranbelumisi-mengikuti-bulan-lalu', [IsiMeteranController::class, 'isi_meteran_mengikuti_bulan_lalu']);
});
